...
def test_mcp_get_task():
    mcp = MCPRun(model="gpt-4o-mini", profile="pachacamac/default", task="QR Generator").init()
    assert mcp.mcprun_presigned_url is not None
...
# presigned_url = "https://www.mcp.run/api/runs/pachacamac/default/QR%20Generator?nonce=0URfJSn8mp8aqPNRGtXrXA&sig=fPS2OEFmspFa5lYPAxSWCsGUbcwvbVH8-daTP02lDDw"

# # def test_mcp_task_end_to_end():
...
#     """
#     task_obj = NewMCPRunTask(name="URL Fetch", description="Fetch a URL", cookiejar=True, store_cookie=True, inputs={"url": "https://unrealists.com"}, output_type="string", presigned_url=presigned_url)
#     task_obj.login()
#     task_obj.run({"url": "https://unrealists.com"})
#     result = task_obj.result()
